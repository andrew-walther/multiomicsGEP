...
tables_dir <- "tables/factor_modular_sim"
figs_dir   <- "figures/factor_modular_sim"
```
...
![RMSE Convergence Trace](figures/factor_modular_sim/fig1_rmse_trace.png){width=90%}
...
![ELBO Proxy Trace](figures/factor_modular_sim/fig2_elbo_proxy.png){width=90%}
...
![Beta Comparison: True vs. Estimated](figures/factor_modular_sim/fig3_beta_comparison.png){width=90%}
...
![GEP Heatmap: Posterior Mean Factor Weights](figures/factor_modular_sim/fig4_gep_heatmap.png){width=90%}
...
![Signal Recovery: True vs. Reconstructed](figures/factor_modular_sim/fig6_signal_recovery.png){width=90%}

## Loading Correlations

![Loading Correlations: True vs. Estimated Factors](figures/factor_modular_sim/fig7_loading_correlations.png){width=90%}
...
![Kaplan-Meier Survival Curves by GEP Score](figures/factor_modular_sim/fig5_kaplan_meier.png){width=90%}
...
![Posterior Tau Distribution](figures/factor_modular_sim/fig8_tau_distribution.png){width=90%}
