...
The top-weighted genes are unusually legible for both:
...
Neither reading is a formal claim. Both are what the gene lists and enrichment tables say
on their face, and both are consistent across two independent methods (fgsea ranking and
...
prognostic value, not whether Program 6 carries survival signal, and it duly came back
