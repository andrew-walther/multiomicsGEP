...
The survival directions are internally consistent: $\hat{\beta}$ sign predicts which Kaplan-Meier arm has worse survival in every active factor across all five configurations. This directional coherence is a necessary condition for the model's survival signal being real rather than artifactual.
