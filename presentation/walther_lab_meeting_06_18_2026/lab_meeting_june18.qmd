...
::::
::: {.notes}
Two equations, one shared L. Every symbol is defined in the table, including the
risk score eta. The baseline hazard is non-parametric — a specific April
...
- The **shared $L$** enters both likelihood terms — that coupling *is* the supervision
...
recommended one. The shared L in both likelihood terms is the supervision, and
...
::: {.notes}
Four takeaways as plain numbered lines. Supervision helps — clearly on synthetic,
