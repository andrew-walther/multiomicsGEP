...
- The 2 survival-active programs are characterized by **5 methods**: gene-set enrichment (fgsea and ORA), correlation with the PurIST classical/basal subtype score, hazard-ratio consistency across all 5 external cohorts, and gene-list overlap with the lab's published DeSurv factors
