...
- **Tests:** Run `Rscript tests/run_tests.R` after any change to a modular update script. Expected: 355/355 passing.
...
| Test suite (core + predict) | `tests/run_tests.R` (355/355) |
