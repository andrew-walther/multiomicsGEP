...
- **Tests:** Run `Rscript tests/run_tests.R` after any change to a modular update script. Expected: 374/374 passing.
...
| Test suite (core + predict) | `tests/run_tests.R` (374/374) |
